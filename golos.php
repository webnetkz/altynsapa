...
<html>
    ...
    <!-- Append blocks -->
        ...
        <div class="preview">
            ...
            <p>
                Өтетін орны : Нұр-Сұлтан қаалсы, «Бейбітшілік және келісім сарайы»
            </p>
            <p>Салтанатты марапаттау кеші: 7 желтоқсан, 2019 жыл, сағ: 19:00</p>
            <p>Қызыл кілем: Басталуы: 17:30</p>
            <p>AFTER PARTY : 21:30</p>
